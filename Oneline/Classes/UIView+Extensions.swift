...
extension UIView {
    ...
    @discardableResult
    func autoresizingMask(_ value: UIViewAutoresizing) -> Self {
    ...
    @discardableResult
    func contentMode(_ value: UIViewContentMode) -> Self {
    ...
    @discardableResult
    func tintAdjustmentMode(_ value: UIViewTintAdjustmentMode) -> Self {
